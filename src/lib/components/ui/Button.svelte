...
<button
	...
	class={[
		className,
		large ? 'px-4 py-3 border-2' : ' px-3 py-2 border-2',
		'relative  border-zinc-400 text-zinc-100 rounded-xl justify-self-end z-1 bg-linear-to-r from-rose-500 to-pink-600',
		...
		disabled
			...
			: 'cursor-pointer hover:before:bottom-0.5 hover:before:rounded-xl hover:border-rose-500 focus-visible:ring-rose-500 focus-visible:ring-2'
	]}
	{onclick}
>
